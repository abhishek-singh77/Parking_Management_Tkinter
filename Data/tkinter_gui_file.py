...
def main():
    ...
    # Park Button
    add = Button(root, text="PARK IN", padx=5, pady=20, fg="black", font=(15), bg="#A8F6CF", command=database)
    add.place(x=150, y=350)
    # Find location Button
    find = Button(root, text="FIND VEHICLE", padx=1, pady=20, fg="black", bg="#72FCFB", font=(15), command=findLoc)
    find.place(x=250, y=350)
    # Remove Vehicle Button
    find = Button(root, text="PARK OUT", padx=1, pady=20, fg="black", bg="#F98576", font=(15), command=deleteDB)
